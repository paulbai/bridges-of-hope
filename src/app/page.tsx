...
export default function Home() {
  ...
  const allPrograms: (CauseDetail & { className: string; featured?: boolean })[] = [
    ...
    },
    {
      ...
      percent: 0,
      imgSrc: "/ballanta.jpg",
      imgAlt: "Students at Ballanta Academy of Music learning keyboard",
    ...
    },
    {
      ...
      goal: "$10k",
      percent: 0,
      imgSrc: "/goodwill.webp",
      imgAlt: "The Goodwill Children Foundation Sierra Leone delivering donations",
